...
<td valign='top' colspan='2'><b>Task Manager</b></td>
</tr>
 ...
 <tr>
                ...
                <td valign='top' width='500'><input type="task_name" name="task_name[]" class="form-control" required="required"></td>
...
<td valign='top' colspan='4'><b>Task Description</b></td>
</tr>
<tr>


                <td valign='top' width='100'><input name="burden_rate[]" class="form-control" required="required"></td>
                <td valign='top' width='100'><input name="target[]" class="form-control" required="required"></td>
                <td colspan='3' valign='top' width='600'><textarea name="task_description[]" class="form-control" required="required"></textarea></td>

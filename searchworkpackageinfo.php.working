...
if(isset($_POST['search']))
{
   ...
   while($row=mysqli_fetch_array($result))
   {
      ...
      $output_str.="<td valign='top' colspan='4'><b>Task Name</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$program</td>\n";
      $output_str.="<td valign='top'>$project</td>\n";
      $output_str.="<td valign='top'>$task</td>\n";
      $output_str.="<td valign='top' colspan='4'>$task_name</td>\n";
      $output_str.="</tr>";

      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td valign='top' colspan='4'><b>Task Manager</b></td>\n";
      ...
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top' colspan='4'>$task_manager</td>\n";
      $output_str.="<td valign='top'>$burden_rate</td>\n";
      $output_str.="<td valign='top'>$startdate</td>\n";
      $output_str.="<td valign='top'>$enddate</td>\n";
      $output_str.="</tr>";

      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td colspan='7' valign='top'><b>Task Description</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td colspan='7' valign='top'>$task_description</td>\n";
      $output_str.="</tr>";
      $termcount++;
    }
   ...
   while($row=mysqli_fetch_array($result))
   {
      ...
      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td valign='top'><b>znumber</b></td>\n";
      $output_str.="<td colspan='2' valign='top'><b>Staff</b></td>\n";
      $output_str.="<td colspan='4' valign='top'><b>Title</b></td>\n";
      $output_str.="<td valign='top'><b>Start Date</b></td>\n";
      $output_str.="<td valign='top'><b>End Date</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$znumber</td>\n";
      $output_str.="<td colspan='2' valign='top'>$staff</td>\n";
      $output_str.="<td colspan='4' valign='top'>$title</td>\n";
      $output_str.="<td valign='top'>$startdate</td>\n";
      $output_str.="<td valign='top'>$enddate</td>\n";
      $output_str.="</tr>";

      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td valign='top'><b>Group Name</b></td>\n";
      $output_str.="<td valign='top'><b>Org Code</b></td>\n";
      $output_str.="<td valign='top'><b>Salary Min</b></td>\n";
      $output_str.="<td valign='top'><b>Salary Max</b></td>\n";
      $output_str.="<td valign='top'><b>Pct FTE</b></td>\n";
      $output_str.="<td valign='top'><b>Cost</b></td>\n";
      $output_str.="<td valign='top'><b>Funded</b></td>\n";
      $output_str.="<td valign='top'><b>Funded Percent</b></td>\n";
      $output_str.="<td valign='top'><b>Total Cost</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$group_name</td>\n";
      $output_str.="<td valign='top'>$org_code</td>\n";
      $output_str.="<td valign='top'>$salary_min</td>\n";
      $output_str.="<td valign='top'>$salary_max</td>\n";
      $output_str.="<td valign='top'>$pct_fte</td>\n";
      $output_str.="<td valign='top'>$cost</td>\n";
      $output_str.="<td valign='top'>$funded</td>\n";
      $output_str.="<td valign='top'>$funded_percent</td>\n";
      $output_str.="<td valign='top'>$total_cost</td>\n";
      $output_str.="</tr>";

      if(trim($notes)!="")
      {
          $output_str.="<tr bgcolor='$column_color'>\n";
          $output_str.="<td colspan='9' valign='top'><b>Notes:</b> $notes</td>\n";
          $output_str.="</tr>";
      }
   ...
   $output_str.="<td colspan='4'></td>";
   $output_str.="<td><b>PCT FTE</b></td>";
   $output_str.="<td><b>Cost</b></td>";
   $output_str.="<td></td>";
   $output_str.="<td><b>Funded %</b></td>";
   $output_str.="<td><b>Total Cost</b></td>";
   $output_str.="</tr>";
   while($row=mysqli_fetch_array($result))
   {
       $pct_fte=$row[0];
       ...
       $output_str.="<tr bgcolor='$totals_color'>";
       $output_str.="<td colspan='4'></td>";
       $output_str.="<td>$pct_fte</td>";
       $output_str.="<td>$cost</td>";
       $output_str.="<td></td>";
       $output_str.="<td>$funded</td>";
       $output_str.="<td>$total_cost</td>";
       $output_str.="</tr>";
   }
   ...
   $termcount=1;
   $output_str.="<tr bgcolor='$column_color'>\n";
   $output_str.="<td valign='top'><b>Service</b></td>\n";
   $output_str.="<td valign='top'><b>Start Date</b></td>\n";
   $output_str.="<td valign='top'><b>End Date</b></td>\n";
   $output_str.="<td valign='top'><b>Owner</b></td>\n";
   $output_str.="<td valign='top'><b>Vendor</b></td>\n";
   $output_str.="<td valign='top'><b>Percent of FOUS</b></td>\n";
   $output_str.="<td valign='top'><b>Risk</b></td>\n";
   $output_str.="<td valign='top'><b>Funded</b></td>\n";
   $output_str.="<td valign='top'><b>Cost</b></td>\n";
   $output_str.="<td valign='top'><b>Total Cost</b></td>\n";
   $output_str.="</tr>";
   while($row=mysqli_fetch_array($result))
   {
      ...
      $currentColor= ${'colour' .($termcount % 2)};
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$service</td>\n";
      $output_str.="<td valign='top'>$startdate</td>\n";
      $output_str.="<td valign='top'>$enddate</td>\n";
      $output_str.="<td valign='top'>$owner</td>\n";
      $output_str.="<td valign='top'>$vendor</td>\n";
      $output_str.="<td valign='top'>$percent</td>\n";
      $output_str.="<td valign='top'>$risk</td>\n";
      $output_str.="<td valign='top'>$funded</td>\n";
      $output_str.="<td valign='top'>$cost</td>\n";
      $output_str.="<td valign='top'>$total_cost</td>\n";
      $output_str.="</tr>";
   ...
   $result=mysqli_query($conn,$query);
   $output_str.="<tr bgcolor='$totals_color'>";
   $output_str.="<td colspan='8'></td>";
   $output_str.="<td colspan='1'><b>Cost</b></td>";
   $output_str.="<td colspan='1'><b>Total Cost</b></td>";
   $output_str.="</tr>";
   while($row=mysqli_fetch_array($result))
   {
       $cost=$row[0];
       ...
       $output_str.="<tr bgcolor='$totals_color'>";
       $output_str.="<td colspan='8'></td>";
       $output_str.="<td colspan='1'>$cost</td>";
       $output_str.="<td colspan='1'>$total_cost</td>";
       $output_str.="</tr>";
   }
   ...
   while($row=mysqli_fetch_array($result))
   {
      ...
      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td valign='top'><b>Property Number</b></td>\n";
      $output_str.="<td valign='top' colspan='10'><b>Description</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$property_number</td>\n";
      $output_str.="<td valign='top'colspan='10'>$description</td>\n";
      $output_str.="</tr>";

      $output_str.="<tr bgcolor='$column_color'>\n";
      $output_str.="<td valign='top'><b>Service Entry</b></td>\n";
      $output_str.="<td valign='top' colspan='3'><b>Owner</b></td>\n";
      $output_str.="<td valign='top'><b>Under Maint</b></td>\n";
      $output_str.="<td valign='top'><b>Percent of FOUS</b></td>\n";
      $output_str.="<td valign='top'><b>Risk</b></td>\n";
      $output_str.="<td valign='top'><b>Replace Fund</b></td>\n";
      $output_str.="<td valign='top'><b>Replacement Cost<b></td>\n";
      $output_str.="<td valign='top'><b>Total Cost</b></td>\n";
      $output_str.="</tr>";
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$service_entry</td>\n";
      $output_str.="<td valign='top' colspan='3'>$owner</td>\n";
      $output_str.="<td valign='top'>$under_maint</td>\n";
      $output_str.="<td valign='top'>$percent</td>\n";
      $output_str.="<td valign='top'>$risk</td>\n";
      $output_str.="<td valign='top'>$replace_fund</td>\n";
      $output_str.="<td valign='top'>$replace_cost</td>\n";
      $output_str.="<td valign='top'>$total_cost</td>\n";
      $output_str.="</tr>";
  ...
  $output_str.="<tr bgcolor='$seperator_color'><td colspan='100%'></td></tr>";
   ...
   $output_str.=display_table_header('Activity Description'); 
   #$output_str.=display_table_header($header_str,4); 

   $termcount=1;
   $output_str.="<tr bgcolor='$column_color'>\n";
   $output_str.="<td valign='top' colspan='2'><b>Activity</b></td>\n";
   $output_str.="<td valign='top'><b>Start Date</b></td>\n";
   $output_str.="<td valign='top'><b>End Date</b></td>\n";
   $output_str.="<td valign='top' colspan='2'><b>Members</b></td>\n";
   $output_str.="<td valign='top' colspan='4'><b>Description</b></td>\n";
   $output_str.="</tr>";
   while($row=mysqli_fetch_array($result))
   {
      $activity=$row[0];
      ...
      $currentColor= ${'colour' .($termcount % 2)};
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top' colspan='2'>$activity</td>\n";
      $output_str.="<td valign='top'>$startdate</td>\n";
      $output_str.="<td valign='top'>$enddate</td>\n";
      $output_str.="<td valign='top' colspan='2'>$members</td>\n";
      $output_str.="<td valign='top' colspan='4'>$description</td>\n";
      $output_str.="</tr>";
      $termcount++;
    }
   ...
   $output_str.="<tr bgcolor='$column_color'>\n";
   $output_str.="<td valign='top'><b>Burden Rate</b></td>\n";
   $output_str.="<td valign='top' colspan='2'><b>Request FTE</b></td>\n";
   $output_str.="<td valign='top' colspan='2'><b>Funded FTE</b></td>\n";
   $output_str.="<td valign='top' colspan='2'><b>Service Costs</b></td>\n";
   $output_str.="<td valign='top' colspan='1'><b>Hardware Inventory</b></td>\n";
   $output_str.="<td valign='top' colspan='1'><b>Hardware Costs</b></td>\n";
   $output_str.="<td valign='top' colspan='1'><b>FY Allocations</b></td>\n";
   $output_str.="</tr>";
   while($row=mysqli_fetch_array($result))
   {
      $burden_rate=$row[0];
      ...
      $output_str.="<tr bgcolor='$currentColor'>\n";
      $output_str.="<td valign='top'>$burden_rate</td>\n";
      $output_str.="<td valign='top' colspan='2'>$request_fte</td>\n";
      $output_str.="<td valign='top' colspan='2'>$funded_fte</td>\n";
      $output_str.="<td valign='top' colspan='2'>$service_costs</td>\n";
      $output_str.="<td valign='top' colspan='1'>$hardware_inventory</td>\n";
      $output_str.="<td valign='top' colspan='1'>$hardware_costs</td>\n";
      $output_str.="<td valign='top' colspan='1'>$fy_allocations</td>\n";
      $output_str.="</tr>";
    }
